...
def calculate_dividend_arbitrage_safety(stock_ticker, risk_tolerance_threshold, num_days):
    try:
        ...
        if is_within_next_n_days(ex_dividend_date, num_days):
            ...
            expected_volatility = stock.info.get('beta', None) * (market_volatility / 0.10)  # Market return set to 10%
...
if __name__ == "__main__":
    ...
    for stock_ticker in sp500_stocks:
        safety_result = calculate_dividend_arbitrage_safety(stock_ticker, user_risk_tolerance, num_days)
